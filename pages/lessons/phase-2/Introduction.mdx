...
We'll refer to this capability as **Targeting Rollouts.** This capability enbles us to use rulesets of varying complexity to affect which variation gets served to a subset of our users. This is useful for a variety or reasons, but a few examples might be:
