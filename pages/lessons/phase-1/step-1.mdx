...
[screenshot of UI highlighting create flag button]
...
- Notice the auto generated `Key` for the flag. This is how you're going to reference your feature flag in code once it's implemented
...
[annotated screenshot of features]
...
- Click the Save flag button
[screenshot highlighting button]
- Once your flag is saved, you'll be brought to the targeting settings for your flag. Click on the feature flag key located directly beneath the Flag name to copy it to your clip board. You can paste it in the box below for safe keeping:
[paste box that uses flag key for next code sample]

Let's be sure to leave the flag targeting settings open in our browser windwow, we'll return to them shortly.
