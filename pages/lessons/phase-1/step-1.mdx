...
![screenshot highlighting save button](/images/save-flag-button.png)
- Once your flag is saved, you'll be brought to the targeting settings for your flag. Which looks like this:
