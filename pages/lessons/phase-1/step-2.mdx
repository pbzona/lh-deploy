...
To do that, we'll head back to the targeting settings for our flag, toggle the Targeting switch to on, and click the save button. Now let's see what our flag evaluates to:
