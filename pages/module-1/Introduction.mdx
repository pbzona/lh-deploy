# Phase 1: Separate Deploy from Release
...
The first of these capabilities we've decided to focus on is **Separating Deploy from Release**.
...
LaunchDarkly makes it possible to quickly roll back changes in Production environments— without having to roll back an entire deployment. So your team can focus on the problem code, rather than firefighting.
