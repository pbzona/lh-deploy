...
For this and the following steps, we'll be making changes to `module02/index.js`. 
...
On line 13 of `module02/index.js` you'll see a call to the `ldclient.variation()` method.
...
<SyntaxHighlighter showLineNumbers="true" startingLineNumber={13} language="javascript" style={docco}>
{
